...
const HARDCODED_FACTS: Fact[] = [
  ...
  f("user-fact-brain-1", "brain", "weird_wild", "mind_blowing", "Your brain generates about 20 watts of electrical power when you're awake—enough to power a dim LED lightbulb."),
  f("user-fact-brain-2", "brain", "weird_wild", "almost_unknown", "The brain itself cannot feel pain. Even though your brain processes all the pain signals from your body, the brain tissue itself has no pain receptors (nociceptors)."),
  f("user-fact-brain-3", "brain", "weird_wild", "surprising", "Your nerve impulses can travel as fast as a race car, zooming up to 268 miles per hour (431 km/h) to deliver messages between your brain and body instantly."),
  f("user-fact-gut-1", "large-intestine", "weird_wild", "surprising", "You have a 'second brain' in your gut (the enteric nervous system) containing around 500 million neurons—more than a rat's entire brain. It's why we get 'butterflies' in our stomachs!"),
  f("user-fact-vessels-1", "heart", "record_breaker", "mind_blowing", "Your blood vessels could wrap around the Earth four times. If you laid all your arteries, veins, and capillaries end-to-end, they would stretch for about 100,000 miles."),
  f("user-fact-rbc-1", "heart", "record_breaker", "surprising", "A single red blood cell can do a full lap of your body in just 20 seconds, moving incredibly fast to drop off oxygen and pick up carbon dioxide."),
  f("user-fact-heart-1", "heart", "record_breaker", "mind_blowing", "Your heart pumps 2,000 gallons of blood every single day. Over an average lifetime, it will beat about 2.5 billion times and pump enough blood to fill 3 average-sized swimming pools."),
  f("user-fact-cornea-1", "eyes", "weird_wild", "almost_unknown", "Your cornea is the only body part that 'breathes' the air directly. Because it has no blood vessels, it pulls oxygen straight out of the air around you."),
  f("user-fact-bones-1", "bones", "record_breaker", "surprising", "Ounce for ounce, your bones are stronger than solid steel. A block of bone the size of a matchbox can support up to 18,000 pounds of weight."),
  f("user-fact-spinal-height", "bones", "weird_wild", "surprising", "You are about 1 centimeter taller in the morning because gravity compresses the soft cartilage discs between your spinal bones during the day while you walk and stand."),
  f("user-fact-baby-bones", "bones", "weird_wild", "surprising", "You lose almost 100 bones as you grow up. Babies are born with about 300 bones, but many fuse together, leaving exactly 206 by adulthood."),
  f("user-fact-jaw-1", "jaw", "record_breaker", "mind_blowing", "The strongest muscle in your body based on its weight is in your jaw (the masseter muscle), which can close your teeth with a force of up to 200 pounds!"),
  f("user-fact-pinky-strength", "hands", "record_breaker", "surprising", "You would lose 50% of your hand strength without your pinky. While the thumb handles fine motor skills, your pinky and ring finger provide the vast majority of your grip strength."),
  f("user-fact-lungs-area", "lung-right", "record_breaker", "surprising", "Your lungs have the surface area of a tennis court. If you flattened out all the tiny air sacs (alveoli) inside them, they would cover between 50 to 75 square meters."),
  f("user-fact-lung-size", "lung-left", "weird_wild", "common", "Your right lung is significantly larger than your left. Because your heart sits slightly to the left side of your chest, your left lung has only two lobes to make room, while the right has three."),
  f("user-fact-breaths-count", "lung-right", "record_breaker", "common", "You breathe about 22,000 times a day. The average adult takes between 12 and 20 breaths per minute, totaling roughly 670 million breaths over a lifetime."),
  f("user-fact-skin-shed", "skin", "weird_wild", "common", "You shed about 40,000 skin cells every single minute. Over a year, you shed about 8 to 9 pounds of dead skin, which makes up most of the dust in your home!"),
  f("user-fact-sweat-odor", "skin", "health_tip", "common", "Sweat itself is completely odorless. Body odor only happens when bacteria on your skin mix with sweat and break it down into smelly acids."),
  f("user-fact-enamel", "jaw", "record_breaker", "common", "Your tooth enamel is the hardest substance in your body—even harder than your bones. However, unlike bones, enamel cannot repair or regrow itself if damaged."),
  f("user-fact-goosebumps", "skin", "weird_wild", "common", "Goosebumps are an evolutionary leftover from when our hairier ancestors got cold or scared, using tiny muscles at the base of each hair follicle to trap heat or look bigger."),
  f("user-fact-dna-length", "skin", "record_breaker", "mind_blowing", "Your DNA could stretch to the sun and back 600 times. If you uncoiled all the DNA packed tightly inside your microscopic cells, it would span roughly 10 billion miles."),
  f("user-fact-microbiome", "large-intestine", "weird_wild", "mind_blowing", "You are practically half-microbe. The human body contains about 30 trillion human cells and roughly 39 trillion bacterial cells, meaning you host more microbes than human cells!"),
  f("user-fact-tears", "eyes", "weird_wild", "surprising", "Humans are the only animals that cry emotional tears. While many animals produce tears to lubricate their eyes, we are the only species that cries due to feelings."),
  f("user-fact-stomach-acid", "stomach", "weird_wild", "mind_blowing", "Your stomach acid could dissolve a razor blade. The hydrochloric acid in your stomach has an incredibly corrosive pH of 1.5 to 3.5."),
  f("user-fact-stomach-lining", "stomach", "weird_wild", "surprising", "Your stomach grows a new lining every few days. To prevent the powerful acid from digesting the stomach itself, the body secretes protective mucus replaced every 3-4 days."),
  f("user-fact-liver-regen", "liver", "record_breaker", "mind_blowing", "The liver is the ultimate regenerative organ. You could safely remove up to 75% of a healthy liver, and it would completely regrow back to its normal size within just a few weeks."),
  f("user-fact-small-intestine-length", "small-intestine", "weird_wild", "surprising", "Your small intestine isn't small at all—it's 22 feet long. It's called 'small' because it is narrow (about 1 inch in diameter), but it is as long as a standard minivan."),
  f("user-fact-saliva", "jaw", "record_breaker", "common", "You produce enough saliva to fill two bathtubs a year, producing about 2 to 4 pints of spit every day to help dissolve and taste your food."),
  f("user-fact-smell-senses", "sinuses", "record_breaker", "mind_blowing", "Your nose can smell over 1 trillion different scents. Recent studies revealed our olfactory system is incredibly advanced, far beyond the old estimate of 10,000 smells."),
  f("user-fact-color-vision", "eyes", "record_breaker", "surprising", "Your eyes can distinguish 10 million different colors. Thanks to cone cells in your retinas, your eyes and brain work together to pick up minute differences in light.")
];
