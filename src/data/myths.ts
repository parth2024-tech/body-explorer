...
export const MYTHS: MythBusted[] = [
  ...
  },
  {
    ...
    reality: "Ear doctors report that 1 in 5 teenagers actually have hearing loss. This is mostly caused by listening to music with headphones turned up way too loud."
  },
  {
    id: "m-sugar-hyperactive",
    bodyPartId: "brain",
    myth: "Eating sugar causes children to become hyperactive.",
    reality: "Pediatricians have proven through many tests that sugar does not make kids hyper. Kids usually just get excited because they are at a fun event like a birthday party."
  },
  {
    id: "m-sleepwalker",
    bodyPartId: "brain",
    myth: "It is dangerous or physically harmful to wake a sleepwalker.",
    reality: "Sleep doctors say it is completely safe to gently wake a sleepwalker. They might be a little confused, but it is much safer than letting them wander and get hurt."
  },
  ...
  // ━━━ METABOLIC & ORGANS ━━━
  {
    ...
    reality: "Stomach doctors confirm that spicy food never causes ulcers. Ulcers are actually caused by a specific stomach bacteria or by taking too many painkillers like ibuprofen."
  },
  {
    id: "m-7",
    bodyPartId: "stomach",
    myth: "Swallowed chewing gum takes seven years to digest in your stomach.",
    reality: "Medical professionals confirm that gum does not stick to your stomach walls. Your body simply pushes it straight through your system and out within a few days."
  },
  {
    id: "m-8",
    bodyPartId: "liver",
  ...
  },
  {
    ...
    reality: "Kidney doctors state that everyone needs a different amount of water. Any liquid you drink, plus water-rich foods like fruit, all count toward keeping you hydrated."
  },
  {
    id: "m-10",
    bodyPartId: "heart",
    myth: "A heart attack always involves chest pain.",
    reality: "Heart doctors warn that you can have a heart attack without any chest pain. Many people, especially women, just feel very sick to their stomach, out of breath, or have back pain."
  },
  {
    id: "m-eggs-cholesterol",
    bodyPartId: "heart",
    myth: "Eggs are bad because they contain cholesterol.",
    reality: "Heart specialists have proven that eating eggs does not clog your arteries. For most people, eggs are just a very healthy and affordable source of protein."
  },
  {
    id: "m-natural-safe",
    bodyPartId: "liver",
  ...
  // ━━━ IMMUNE & RESPIRATORY ━━━
  {
    ...
    reality: "Infectious disease doctors confirm that you only get a cold from a virus, not from cold air. We get sick more in winter because we are crowded indoors with other sick people."
  },
  {
    id: "m-vit-c",
    bodyPartId: "lung-left",
    myth: "Taking large doses of Vitamin C prevents the common cold.",
    reality: "Immune system experts have proven that Vitamin C does not stop you from catching a cold. It might only make the cold go away slightly faster once you already have it."
  },
  {
    id: "m-12",
    bodyPartId: "skin",
    myth: "You don't need sunscreen on a cloudy day.",
    reality: "Skin doctors warn that up to 80% of the sun's harmful rays easily pass right through clouds. You can absolutely get a terrible sunburn even when you can't see the sun."
  },
  {
    id: "m-13",
    bodyPartId: "skin",
    myth: "Acne is caused by dirty skin and poor hygiene.",
    reality: "Dermatologists confirm that washing your face more will not cure acne. Acne is actually caused by natural hormones and oil trapped deep under the skin, not surface dirt."
  },
  {
    id: "m-14",
    bodyPartId: "skin",
    myth: "Shaving makes your hair grow back thicker, darker, and faster.",
    reality: "Skin experts explain that shaving just cuts the hair straight across, making it feel rough and prickly as it grows. Shaving does not actually change the hair thickness at all."
  },
  {
    id: "m-sweat-fat",
    bodyPartId: "skin",
    myth: "You need to sweat to burn fat.",
    reality: "Fitness doctors explain that sweating is just your body's way of cooling down when you get hot. You burn fat by using energy, which has nothing to do with how much you sweat."
  },
  {
    id: "m-head-heat",
    bodyPartId: "skin",
    myth: "You lose most body heat through your head.",
    reality: "Medical experts confirm that you lose heat evenly from any bare skin. Your head doesn't lose heat any faster than your bare arm or leg would."
  },
  ...
  // ━━━ MUSCULOSKELETAL ━━━
  {
    ...
    reality: "Bone doctors confirm that cracking your knuckles is perfectly safe. The \"pop\" sound is just tiny gas bubbles bursting in your joints, and it will never cause arthritis."
  },
  {
    id: "m-16",
    bodyPartId: "bones",
    myth: "Adults don't grow new bone cells.",
    reality: "Bone specialists explain that your skeleton is very much alive. Your body constantly breaks down old bone and builds brand new bone, replacing your entire skeleton every 10 years."
  },
  {
    id: "m-17",
    bodyPartId: "muscles",
    myth: "Lactic acid causes muscle soreness days after a workout.",
    reality: "Sports doctors confirm that lactic acid leaves your body right after you stop working out. The soreness you feel the next day is actually tiny, healthy tears in your muscles healing."
  },
  {
    id: "m-18",
    bodyPartId: "spine-lumbar",
    myth: "Bed rest is the best treatment for back pain.",
    reality: "Spine doctors warn that staying in bed actually makes back pain worse because your muscles get weak. Going for gentle walks is the fastest medical way to heal your back."
  },
  {
    id: "m-19",
    bodyPartId: "knees",
    myth: "Running ruins your knees.",
    reality: "Joint specialists have proven that regular running actually makes your knee joints thicker and stronger. Runners usually have far healthier knees than people who don't exercise."
  },
  {
    id: "m-20",
    bodyPartId: "shoulders",
    myth: "Poor posture is the only cause of shoulder pain.",
    reality: "While posture matters, sports doctors note that most shoulder pain simply comes from age and everyday wear-and-tear on your muscles, rather than just sitting poorly."
  },
  ...
  // ━━━ NUTRITION & GENERAL ━━━
  {
    ...
    reality: "Stomach doctors advise that unless you have a specific allergy, going gluten-free is actually bad for you. Gluten-filled whole grains give your heart essential nutrients."
  },
  {
    id: "m-22",
    bodyPartId: "large-intestine",
    myth: "You should have a bowel movement every single day.",
    reality: "Digestive experts say that going anywhere from three times a day to three times a week is completely normal. As long as your routine is consistent, you are perfectly healthy."
  },
  {
    id: "m-23",
    bodyPartId: "stomach",
    myth: "Eating food late at night automatically causes weight gain.",
    reality: "Weight loss doctors confirm that your body doesn't care what time it is. You only gain weight if you eat more total food in a day than your body burns for energy."
  },
  {
    id: "m-24",
    bodyPartId: "throat",
    myth: "Feed a cold, starve a fever.",
    reality: "Immune doctors confirm that fighting any sickness takes a massive amount of energy. You always need to eat good food and drink plenty of water, whether you have a cold or a fever."
  },
  {
    id: "m-25",
    bodyPartId: "heart",
    myth: "If you have heart disease, you should take it easy and avoid exercise.",
    reality: "Heart doctors strictly warn that sitting on the couch is the worst thing you can do for a bad heart. Safe, guided exercise is exactly what doctors prescribe to fix heart problems."
  }
];
