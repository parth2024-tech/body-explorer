  ...
  return (
    <div className="min-h-screen bg-[#030303] text-[#EAEAEA] font-sans selection:bg-[#FC3D21]/30">
      ...
      <div className="hidden print:block p-8 text-black bg-white min-h-screen">
        ...
        {selectedMolecule ? (
          <div>
            <h2 className="text-2xl font-bold mb-2 uppercase">{selectedMolecule.molecule}</h2>
            <p className="mb-4"><strong>Indian Brands:</strong> {selectedMolecule.brand_names_india.join(', ')}</p>
